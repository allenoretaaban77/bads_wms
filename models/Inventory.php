...
class Inventory extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            //[['product_name', 'sku', 'cost_per_unit', 'price_per_unit', 'initial_qty', 'reorder_level', 'current_qty', 'rack', 'shelf', 'box', 'status', 'remarks'], 'required'],
            ...
            [['rack', 'shelf', 'box', 'status', 'remarks'], 'string', 'max' => 50],
