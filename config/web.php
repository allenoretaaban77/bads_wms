...
$config = [
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                // 'GET,OPTIONS api/replenishment/getsuppliers' => 'replenishment/getsuppliers',
                ...
                // 'POST,OPTIONS api/suppliers/create' => 'suppliers/create',
                // 'PUT,OPTIONS api/suppliers/update' => 'suppliers/update',
                // 'PATCH,OPTIONS api/suppliers/update' => 'suppliers/update',
    ...
    'as corsFilter' => [
        ...
        'cors' => [
            'Origin' => [
                'http://localhost:3000', 
                'http://badongs.hardware.inventory.system'
            ],
